 ...
 *
 * <pre>
 * 增强 CallableStatement。
 *
 * 扩展方法的执行步骤见{@link org.apache.skywalking.apm.plugin.jdbc.trace.CallableStatementTracing#execute(CallableStatement, ConnectionInfo, String, String, CallableStatementTracing.Executable)}
 *
...
public class SWCallableStatement implements CallableStatement {
    ...
    public ResultSet executeQuery() throws SQLException {
        // 扩展原始方法
        return CallableStatementTracing.execute(
                realStatement, connectInfo, "executeQuery", sql,
                new CallableStatementTracing.Executable<ResultSet>() {
                    @Override
