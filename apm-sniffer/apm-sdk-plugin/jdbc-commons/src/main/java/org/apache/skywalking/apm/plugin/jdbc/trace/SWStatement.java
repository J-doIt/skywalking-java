 ...
 * 增强 Statement。
 *
 * 扩展方法的执行步骤见{@link org.apache.skywalking.apm.plugin.jdbc.trace.StatementTracing#execute(Statement, ConnectionInfo, String, String, StatementTracing.Executable)}
 *
...
public class SWStatement implements java.sql.Statement {
    ...
    /* Connection.createStatement() 返回的原始对象 */
